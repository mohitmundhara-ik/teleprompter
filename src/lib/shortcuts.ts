export const SHORTCUTS = [
  ...
  { keys: 'P', what: 'Present: the slide alone fills the tab', where: 'Main window' },
  { keys: 'F', what: 'Full screen on this monitor', where: 'Both windows' },
  { keys: 'T', what: 'Open or focus the teleprompter', where: 'Main window' },
  { keys: 'Escape', what: 'Leave presenting or full screen, restore controls', where: 'Both windows' },
];
